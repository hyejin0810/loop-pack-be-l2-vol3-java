...
@StepScope
@Component
public class WeeklyRankingItemProcessor implements ItemProcessor<ProductMetrics, ProductRankWeekly> {
    ...
    @Override
    public ProductRankWeekly process(ProductMetrics item) {
